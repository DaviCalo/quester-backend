...
routes.delete('/delete-all-user', controllers.deleteAllUsers);
routes.delete('/delete-all-question', controllers.deleteAllQuestions);
routes.delete('/delete-all-match', controllers.deleteAllMatches);
routes.delete('/delete-all-waiting-match', controllers.deleteWaitingMatches);
routes.get('/find-all', controllers.findAllUser);
routes.get('/find-all-waiting-match', controllers.getAllWaitingMatches);
routes.get('/find-all-question', controllers.findAllQuestions);
routes.get('/find-all-match', controllers.findAllMatches);
routes.delete('/deletebyIDCreatedMatches/:iduser/:idmach', controllers.deleteCreatedMatch);
